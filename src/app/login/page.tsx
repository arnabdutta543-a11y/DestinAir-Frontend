  ...
  return (
    <div className="min-h-screen flex flex-col bg-sky-50 dark:bg-slate-950">
      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md glass rounded-2xl p-8 shadow-2xl shadow-sky-900/10">
          {/* Logo */}
          ...
          <h1 className="text-h2 text-center text-slate-900 dark:text-white mb-2">Welcome back</h1>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-12 btn-touch gap-3 mb-6 font-semibold"
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full h-12 bg-sky-600 hover:bg-sky-700 text-white font-semibold btn-touch"
              disabled={loading}
              id="login-submit-btn"
            >
